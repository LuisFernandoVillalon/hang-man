...
public class HangmanGame extends Application {
    ...
    public void start(Stage primaryStage) {
       ...
       Image image = new Image("./images/hangtree.png");
       Image head = new Image("./images/head.png");
       Image torso = new Image("./images/torso.png");
       Image rightarm = new Image("./images/rightarm.png");
       Image leftarm = new Image("./images/leftarm.png");
       Image rightleg = new Image("./images/rightleg.png");
       Image leftleg = new Image("./images/leftleg.png");
